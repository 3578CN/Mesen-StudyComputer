...
#include "NES/Mappers/StudyComputer/Sb2kPpu.h" // （用于 SB2K 专用 UM6576 PPU）
...
#include "InteropDLL/EmuApiWrapper.h"
...
FloppyDriveController* NesConsole::GetFdc()
{
	return InteropGetFdc();
}
...
void NesConsole::SetPpuUm6576(bool isUm6576)
{
	// 替换 PPU 实例。
	if(isUm6576) {
